...
export const FEATURES_DESC = {
  ...
  "energy": "Energetic tracks feel fast, loud, and noisy. For example, death metal has high energy, while a Bach prelude scores low on the scale. ",
  "speechiness": "How verbose your music is, measured by the presence of spoken words in a track. ", 
