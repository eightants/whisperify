...
export const formatNumberCustom = (n: number, decimals = 1) => {
  if (n == 0) return "0";
  const k = 1000;
  const sizes = ["", "K", "M", "B", "T"];
...
export const FEATURES_DESC = {
  acousticness:
    "How prominent acoustic elements are in your listening preferences. ",
  danceability:
    "How suitable a track is for dancing based on tempo and other musical elements. ",
  energy:
  ...
  speechiness:
    "How verbose your music is, measured by the presence of spoken words in a track. ",
  valence:
    "Tracks with high valence sound more positive or happy, while tracks with low valence sound more sad or angry. ",
  liveness:
    "The presence of audience and other live elements in the track, a higher score means a higher likelihood the track was performed live. ",
};

export const allFeaturesToAdd = [
  "acousticness",
  "danceability",
  "energy",
  "valence",
...
export const ALL_SPOTIFY_COUNTRIES = [
  "Albania",
  "Algeria",
  "Andorra",
  "Argentina",
