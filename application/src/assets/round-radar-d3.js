...
function RadarChart(id, data, options) {
	...
	//Append a g element		
	var g = svg.append("g")
            .attr("transform", "translate(" + cfg.w/2 + "," + cfg.h/2 + ") scale(0.7,0.7)");
	...
	if (cfg.showAxesLabels) {
		...
		axis.append("text")
			.attr("class", "legend")
			.style("font-size", cfg.axesLabelsSize)
	...
	blobCircleWrapper.selectAll(".radarInvisibleCircle")
		...
		.on("mouseover", function(d,i) {
			verticesTooltip.style("opacity", 1)
		...
		.on("mouseout", function(){
			verticesTooltip.transition().duration(200)
				.style("opacity", 0);
        });
